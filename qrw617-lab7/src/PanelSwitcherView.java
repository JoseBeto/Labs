...
public class PanelSwitcherView extends JFrame {
    ...
    /*
     * Moved JButton button here so all methods in 
     * 	this class can access it.
     */
    private JButton button;

    /**
     * PanelSwitcherView Constructor creates and modifies 2
     * 	panels to switch between and the button to switch.
     */
    ...
    /**
     * register registers button to PanelSwitcherController
     * @param listener
     */
